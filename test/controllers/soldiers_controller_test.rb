...
class SoldiersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create soldier" do
    assert_difference('Soldier.count') do
      post soldiers_url, params: { soldier: { day_of_birth: @soldier.day_of_birth, firstname: @soldier.firstname, lastname: @soldier.lastname } }
    end
  ...
  test "should update soldier" do
    patch soldier_url(@soldier), params: { soldier: { day_of_birth: @soldier.day_of_birth, firstname: @soldier.firstname, lastname: @soldier.lastname } }
